        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-4/6 lg:w-1/2 py-4 md:py-8 px-5 md:px-10">
                <div class="mb-10">
                    ...
                    <p class="text-center text-qua opacity-80">{{ __('messages.auth.sub_title_log') }}</p>
                </div>
                <form id="loginForm">
                    ...
                    <div class="w-full px-3 mb-8">
                        <p>
                            <span class="text-qua opacity-80">{{ __('messages.auth.dont_have_acc') }}</span>
                            <a href="{{ route('register') }}" class="text-ter">{{ __('messages.auth.register') }}</a>
                        </p>
                    </div>
                    <div class="w-100 flex items-center">
                        <div class="w-3/4">
                            <button type="submit" class="block max-w-xs bg-ter hover:bg-gray-900 text-qua rounded-xl px-5 py-3 font-semibold">
                                <p class="span-text">{{ __('messages.auth.login') }}</p>
                        ...
                        {{-- <div class="w-1/4 flex items-center justify-between">
                            ...
                            <button class="hover:bg-gray-900 rounded-full p-3">
...
@push('scripts')
    <script src="{{ url('js/auth/login.js') }}" type="module"></script>
@endpush
